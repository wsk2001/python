...
class XfcApi:
    def __init__(self):
        self.id = ft.TextField(label="ID", color="red")
        self.remark = ft.TextField(label="Remark", width=920, color="red")
        self.createTime = ft.TextField(label="Create Time", color="red")
        self.updateTime = ft.TextField(label="Update Time", color="red")
        ...
        self.domainKeyId = ft.TextField(label="도메인 Key Id", width=610)
        self.domainAlgorithm = ft.TextField(label="도메인 암호화 Algorithm")
        self.domainKeyLength = ft.TextField(label="도메인 키 길이")
        self.modulus = ft.TextField(label="modulus", width=1230)
        self.publicExponent = ft.TextField(label="publicExponent", width=1230)
        self.privateExponent = ft.TextField(label="privateExponent", width=1230)
        self.domainCode = ft.TextField(label="도메인 코드", width=1230)
        ...
        self.attributeKeyMaterial = ft.TextField(label="attributeKeyMaterial", width=610)
